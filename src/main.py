...
from src.storage.db import DatabaseNotPersistent, DatabaseUnwritable, LegacyDatabase
...
def main() -> int:
    ...
    try:
        ...
        app.run_polling()
    except (ModelConfigError, DatabaseNotPersistent, DatabaseUnwritable, LegacyDatabase) as exc:
